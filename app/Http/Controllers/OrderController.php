...
class OrderController extends Controller
{
    ...
    {
        // Fetch the orders along with required relationships
        $orders = Order::select('order_id as Order_id', 'created_at as Order_date', 'order_status as Status')
            ->with([
                'orderDetails' => function ($query) {
                    $query->select('order_id', 'rice_type', 'total_selling_price as total');
                },
                'customer' => function ($query) {
                    $query->select('customer_id', 'name as Customer_name');
                },
            ])
            ->get();
        ...
        return view('store_manager.order.index', compact('orders'));
    }

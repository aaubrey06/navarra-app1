...
class SalesController extends Controller
{
    ...
    {
        // Fetch the sales data (adjust the query as needed)
        $sales = Sale::all(); // or use any specific query to fetch the sales data you need
        
        // Other sales data for the overview
        $totalSales = Sale::sum('total_price'); // Calculate total sales
        $totalOrders = Sale::count(); // Count total transactions
        $orderstoreOrdersCount = OrderStore::count(); // Count store orders
        $salesTableOrdersCount = Sale::count(); // Count retail sales orders
    
        // Pass the data to the view
        return view('store_manager.sales.index', compact('sales', 'totalSales', 'totalOrders', 'orderstoreOrdersCount', 'salesTableOrdersCount'));
    }
    ...
    public function sales(Request $request)
    {
        ...
        // Pass the data to the view
        return view('owner.sales.sales', compact('sales', 'totalSales', 'totalOrders', 'orderstoreOrdersCount', 'salesTableOrdersCount'));
    }
